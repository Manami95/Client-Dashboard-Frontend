...
export function LiveDataDisplay({ deviceId }: LiveDataDisplayProps) {
  ...
  const getColorClasses = (paramColor: string, type: "bg" | "text" | "border" | "from" | "to") => {
    const colorMap: Record<string, Record<string, string>> = {
      ...
      teal: {
        ...
        from: "from-teal-50 dark:from-teal-950",
      ...
      indigo: {
        ...
        from: "from-indigo-50 dark:from-indigo-950",
        to: "to-indigo-100 dark:to-indigo-900",
      },
      orange: {
        bg: "bg-orange-100 dark:bg-orange-900",
        text: "text-orange-700 dark:text-orange-300",
        border: "border-orange-200 dark:border-orange-800",
        from: "from-orange-50 dark:from-orange-950",
        ...
        <div className="flex justify-between items-center">
          <div>
            <CardTitle className="flex items-center">
              ...
              {isOffline ? "Last Known Sensor Data" : "Live Sensor Data"}
            </CardTitle>
            <CardDescription>
              {isOffline
